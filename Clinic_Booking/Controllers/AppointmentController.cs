...
namespace Clinic_Booking.Controllers
{
    ...
    public class AppointmentController : BaseApiController
    {
        ...
        public async Task<ActionResult<PaginationDto.PageResult<BookingDetailsDto>>> GetMineForDoctorAsync(
            [FromQuery] SearchAppointmentDto form,
            [FromQuery] int page = 1,
            [FromQuery] int pageSize = 10)
        {
            return await _service.GetMineForDoctorAsync(form, page, pageSize);
        }
        ...
        [HttpGet("my")]
        [Authorize]
        public async Task<ActionResult<PaginationDto.PageResult<BookingDetailsDto>>> GetMyAppointmentsAsync(
            [FromQuery] DateOnly? fromDate,
            [FromQuery] DateOnly? toDate,
            [FromQuery] int page = 1,
            [FromQuery] int pageSize = 10)
        {
            return await _service.GetMyAppointmentsAsync(fromDate, toDate, page, pageSize);
        }
        ...
        [HttpGet("doctor/next-upcoming")]
        [Authorize(Roles = AppRoles.DoctorUser)]
        public async Task<IActionResult> GetNextUpcomingAsync()
        {
            return await _service.GetNextUpcomingAsync();
        }
        ...
        {
            return await _service.GetDoctorStatisticsAsync();
        }
