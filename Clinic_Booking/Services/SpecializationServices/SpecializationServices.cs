...
namespace Clinic_Booking.Services.SpecializationServices
{
    public class SpecializationServices : ISpecializationServices
    {
        readonly ApplicationDbContext _context;
        public SpecializationServices(ApplicationDbContext context)
        {
            _context = context;
        }
        public async Task<IActionResult> GetItemsAsync()
        {
            try
            {
                var days = await _context.Specializations
                    .Where(d => !d.IsDeleted)
                    .Select(d => new
                    {
                        d.Id,
