...
new Specialization { Id = 44, Name = "أخصائي الوراثة الطبية", NormalizedName = "Medical Geneticist", IconName = "medical-genetics" }
            ...
            modelBuilder.Entity<RequestForm>(entity =>
            {
                ...
                entity.Property(e => e.KnownName).IsRequired().HasMaxLength(200);
                entity.Property(e => e.IdentityFront).IsRequired().HasMaxLength(500);
                entity.Property(e => e.IdentityBack).HasMaxLength(500);
                entity.Property(e => e.RejectedReason).HasMaxLength(500);
                entity.Property(e => e.Code).IsRequired().HasMaxLength(20);
                entity.HasIndex(e => e.Code).IsUnique();
                entity.HasIndex(e => new { e.UserId, e.RequestStatus, e.IsDeleted });
                entity.HasIndex(e => new { e.RequestStatus, e.IsDeleted });

                entity.Property(e => e.IraqiProvince)
                    .HasConversion<int>();
            ...
            modelBuilder.Entity<ClinicException>().HasQueryFilter(e => !e.IsDeleted);
            ...
            modelBuilder.Entity<DoctorSubscription>().HasQueryFilter(e => !e.IsDeleted);
            modelBuilder.Entity<DoctorFeature>().HasQueryFilter(e => !e.IsDeleted);
            modelBuilder.Entity<DoctorOffer>().HasQueryFilter(e => !e.IsDeleted);
            ...
            modelBuilder.Entity<UserFavoriteDoctor>().HasQueryFilter(e => !e.IsDeleted);
modelBuilder.Entity<RequestForm>().HasQueryFilter(e => !e.IsDeleted);
        }
    }
}
