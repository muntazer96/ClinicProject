  ...
  routes: [
    { path: '/login', name: 'login', component: LoginView, meta: { guestOnly: true } },
    {
      ...
      children: [
        ...
        { path: 'appointments', name: 'appointments', component: PlaceholderView, meta: { title: 'الحجوزات اليومية', roles: ['DoctorUser'] } },
        { path: 'exceptions', name: 'exceptions', component: PlaceholderView, meta: { title: 'الإجازات والاستثناءات', roles: ['DoctorUser'] } },
        { path: 'reviews', name: 'reviews', component: PlaceholderView, meta: { title: 'التقييمات', roles: ['DoctorUser'] } },
